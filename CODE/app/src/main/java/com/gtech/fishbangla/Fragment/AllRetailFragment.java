 ...
 */
public class AllRetailFragment extends Fragment {
    ...
    RecyclerView retail_recyclerView;

    ApiInterface apiInterface = ApiClient.getBaseClient().create(ApiInterface.class);
    String category_id = "0";

    public AllRetailFragment() {
        // Required empty public constructor
    }

    @SuppressLint("ValidFragment")
    public AllRetailFragment(Context context, String s) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = inflater.inflate(R.layout.fragment_all_retail, container, false);
        try {
            retail_recyclerView = view.findViewById(R.id.retail_recycleview);
            initial_ratail();
        } catch (Exception e) {
    ...
    public void initial_ratail() {
        ...
        retail_recyclerView.setLayoutManager(mLayoutManager);
        retail_recyclerView.setItemAnimator(new DefaultItemAnimator());
        retail_recyclerView.setAdapter(homeSuggestAdapter);
        Get_Product(new Send_Product_Category(category_id, "1"));
    }
                        ...
                        try {
                            ...
                            if (response.isSuccessful() && response != null) {
                                ...
                                if (api_response.getCode() == 200) {
                                    ...
                                    Log.d("PRODUCT CATEGORY", get_products.size() + "");
                                    products.clear();
    ...
    private BroadcastReceiver mReceiverLocation = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            try {
                ...
                send_filter_product.setPostTypeId("1");
